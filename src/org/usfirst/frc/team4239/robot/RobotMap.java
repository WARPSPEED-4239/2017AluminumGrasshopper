...
public class RobotMap {
	...
	public static final int
		SOLENOID_GEAR_PICKUP_MECHANISM_LIFT_FORWARD = 3,
		SOLENOID_GEAR_PICKUP_MECHANISM_LIFT_REVERSE = 4,
		SOLENOID_GEAR_PICKUP_MECHANISM_CLAMP_FORWARD = 6,
		SOLENOID_GEAR_PICKUP_MECHANSIM_CLAMP_REVERSE = 5;
